...
ライブラリ化によって見やすくはなったが、それでも golang 特有のパッケージ宣言やインポート宣言や main 関数の宣言など、毎回同じ内容を記述するのは無駄が多い。なくしてしまいたい。
...
SMT Solver の利用者としては、こういうどうでもいいことはなくしてしまいたい。
...
ここまででだいぶ見通しはよくなったし、記述量も低減できるようになった。

しかしそれでも、制約条件が直感的な記述ではない。
